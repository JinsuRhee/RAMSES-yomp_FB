...
c
     ...
     *		yieo1,yiemg1,yiesi1,yies1,yiefe1,tmass,tmass_js
...
c
      ...
      if (icout .eq. 1) then
          tmass_js = tmass_js + (yield1*time_in)
      else
          tmass_js = tmass_js + (yield1*tstep)
      endif
c    
...
c500    format(1x,e10.5,2x,9f8.3,2x,f8.3,2x,f8.3,2x,f8.3,2x,f8.3)
     ...
     *    alog10(yield1+1.e-30),alog10(tmass_js+1.e-30)
