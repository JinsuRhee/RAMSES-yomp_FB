...
c
	 do k=2,12
	    ...
	    yfen =rmass*(yfe(kz,k)-yfe(kz,k-1))+yfe(kz,k-1)
          ...
          if(l.eq.lstart) WRITE(93,*) cmass(l), zmass(l), 
     * yhn+yhen+ycn+ynn+yon+ymgn+ysin+ysn+yfen, time_in, icount,
     * lstart, lend, lstep
c%123123
c
...
c     *    alog10(yieh1+1.e-30),
c     *    alog10(yiehe1+1.e-30),alog10(yiec1+1.e-30),
c     *    alog10(yien1+1.e-30),alog10(yieo1+1.e-30),
c     *    alog10(yiemg1+1.e-30),alog10(yiesi1+1.e-30),
c     *    alog10(yies1+1.e-30),alog10(yiefe1+1.e-30),
c     *    alog10(yieh2+1.e-30),
c     *    alog10(yiehe2+1.e-30),alog10(yiec2+1.e-30),
c     *    alog10(yien2+1.e-30),alog10(yieo2+1.e-30),
c     *    alog10(yiemg2+1.e-30),alog10(yiesi2+1.e-30),
c     *    alog10(yies2+1.e-30),alog10(yiefe2+1.e-30),
c     *    alog10(yield1+1.e-30),alog10(yield2+1.e-30),
c     *    alog10(yield+1.e-30),alog10(tmass+1.e-30)
c500    format(1x,e10.5,2x,18f8.3,2x,f8.3,2x,f8.3,2x,f8.3,2x,f8.3)
c
c      	   write(930,600)
c600 	   format('  <datarow>')
